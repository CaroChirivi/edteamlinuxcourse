<?php
	...
	*/
	...
	$db_username 	=	"root";			// specify database username | default is "root"r
	$db_password 	=	"**2020EvangelionMySql2020**";				// specify database password | leave as blank if database has no password set 
